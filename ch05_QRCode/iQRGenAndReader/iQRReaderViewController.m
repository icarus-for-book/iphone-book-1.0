...
{    
    ...
    if(indexPath.row == 1) {
        ...
        if(imageView.image != nil) {
            [[[[UIActionSheet alloc] initWithTitle: nil delegate: self cancelButtonTitle: @"Cancel" destructiveButtonTitle:nil otherButtonTitles: @"Save Image", nil] autorelease] showInView: self.view];

...
- (id)init
{
    ...
    if (self) {
        ...
        _reachablilityForInternet = [[Reachability reachabilityForInternetConnection] retain];
        _reachablilityForLocalWifi = [[Reachability reachabilityForLocalWiFi] retain];

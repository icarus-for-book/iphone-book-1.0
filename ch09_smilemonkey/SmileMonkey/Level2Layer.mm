...
-(id) init
{
	if( (self=[super init])) {
		...
		// 배경 화면 설정 
        CCSprite *sprite = [CCSprite spriteWithFile:@"ocean.jpg"];
        ...
        // 문자열 출력
        CCLabelTTF *label = [CCLabelTTF labelWithString:@"Level2 Ocean Mission" fontName:@"Marker Felt" fontSize:32];
...
- (void)resetUnit
{
    ...
    {       
        ...
        [[GameManager myGameManager] runSceneWithID:kLevel3Scene];
    }
...
- (void)createTargets
{
    ...
    [self createTarget:@"rock2.png"atPosition:CGPointMake(450.0, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:YES isEnemy:NO];    
    [self createTarget:@"rock1.png"atPosition:CGPointMake(540.0, FLOOR_HEIGTH+19) rotation:90.0f isCircle:NO isStatic:NO isEnemy:NO];        
    [self createTarget:@"rock1.png"atPosition:CGPointMake(540.0, FLOOR_HEIGTH+101) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];    
    [self createTarget:@"wood2.png"atPosition:CGPointMake(540.0, FLOOR_HEIGTH+143) rotation:90.0f isCircle:NO isStatic:NO isEnemy:NO];    
    
    [self createTarget:@"wood1.png"atPosition:CGPointMake(431.0, FLOOR_HEIGTH+19) rotation:90.0f isCircle:NO isStatic:NO isEnemy:NO];    
    [self createTarget:@"clam.png"atPosition:CGPointMake(580, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:NO isEnemy:YES]; 
    [self createTarget:@"wood1.png"atPosition:CGPointMake(540.0, FLOOR_HEIGTH+19) rotation:90.0f isCircle:NO isStatic:NO isEnemy:NO];    
    [self createTarget:@"shark.png"atPosition:CGPointMake(450.0, FLOOR_HEIGTH+220) rotation:0.0f isCircle:NO isStatic:YES isEnemy:YES]; 
    [self createTarget:@"shrimp.png"atPosition:CGPointMake(350, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:NO isEnemy:YES]; 
    [self createTarget:@"shrimp.png"atPosition:CGPointMake(775.0, FLOOR_HEIGTH+200) rotation:0.0f isCircle:NO isStatic:YES isEnemy:YES]; 
    
    [self createTarget:@"rock2.png"atPosition:CGPointMake(735.0, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"rock1.png"atPosition:CGPointMake(775.0, FLOOR_HEIGTH+19) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"rock2.png"atPosition:CGPointMake(735.0, FLOOR_HEIGTH+61) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO]; 
    [self createTarget:@"rock3.png"atPosition:CGPointMake(775.0, FLOOR_HEIGTH+80) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO]; 
    [self createTarget:@"clam.png"atPosition:CGPointMake(780, FLOOR_HEIGTH+122) rotation:0.0f isCircle:NO isStatic:NO isEnemy:YES]; 
    [self createTarget:@"clam.png"atPosition:CGPointMake(735, FLOOR_HEIGTH+80) rotation:0.0f isCircle:NO isStatic:NO isEnemy:YES]; 
    
    [self createTarget:@"rock5.png"atPosition:CGPointMake(680.0, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"rock5.png"atPosition:CGPointMake(680.0, FLOOR_HEIGTH+20) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"rock5.png"atPosition:CGPointMake(680.0, FLOOR_HEIGTH+40) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"shark.png"atPosition:CGPointMake(680.0, FLOOR_HEIGTH+180) rotation:0.0f isCircle:NO isStatic:YES isEnemy:YES]; 
}

...
-(id) init
{
	if( (self=[super init])) {
		...
		// 배경 화면 설정 
        CCSprite *sprite = [CCSprite spriteWithFile:@"desert.jpg"];
        ...
        // 문자열 출력
        CCLabelTTF *label = [CCLabelTTF labelWithString:@"Level1 Desert Mission" fontName:@"Marker Felt" fontSize:32];
...
- (void)resetUnit
{
    ...
    {       
        ...
        [[GameManager myGameManager] runSceneWithID:kLevel2Scene];
    }
...
- (void)createTargets
{
    ...
    [self createTarget:@"rock3.png"atPosition:CGPointMake(500.0, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:YES isEnemy:NO];
    [self createTarget:@"rock3.png"atPosition:CGPointMake(520.0, FLOOR_HEIGTH+41) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];
    [self createTarget:@"rock3.png"atPosition:CGPointMake(530.0, FLOOR_HEIGTH+82) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];    
    
    
    [self createTarget:@"rock2.png"atPosition:CGPointMake(550.0, FLOOR_HEIGTH+123) rotation:0.0f isCircle:NO isStatic:YES isEnemy:NO];    
    [self createTarget:@"rock2.png"atPosition:CGPointMake(754.0, FLOOR_HEIGTH+123) rotation:0.0f isCircle:NO isStatic:YES isEnemy:NO];    
    
    
    [self createTarget:@"beetle.png"atPosition:CGPointMake(600, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:YES isEnemy:YES];    
    [self createTarget:@"rock4.png"atPosition:CGPointMake(754.0, FLOOR_HEIGTH+20) rotation:0.0f isCircle:NO isStatic:YES isEnemy:NO];    
    [self createTarget:@"wood2.png"atPosition:CGPointMake(800.0, FLOOR_HEIGTH) rotation:90.0f isCircle:NO isStatic:NO isEnemy:NO];
    
    
    [self createTarget:@"rock5.png"atPosition:CGPointMake(880.0, FLOOR_HEIGTH) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];   
    [self createTarget:@"rock5.png"atPosition:CGPointMake(870.0, FLOOR_HEIGTH+30) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];    
    [self createTarget:@"rock5.png"atPosition:CGPointMake(890.0, FLOOR_HEIGTH+50) rotation:0.0f isCircle:NO isStatic:NO isEnemy:NO];    
    
    
    [self createTarget:@"scorpion.png"atPosition:CGPointMake(685.0,FLOOR_HEIGTH+142) rotation:0.0f isCircle:NO isStatic:YES isEnemy:YES];        
